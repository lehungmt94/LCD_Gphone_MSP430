#define CS	BIT3 //Chon chip P2.3
#define SDA	BIT0 //Data SPI P2.0
#define AO	BIT1 //Chot du lieu Command va Data (C/D) P2.1
#define SCK	BIT2 //Clock SPI  P2.2
...
void config_glcd(){
      ...
      __delay_cycles(50000);	   //Delay 100ms
...
void lcd_image24x24(unsigned char image, unsigned char x, unsigned char y){
